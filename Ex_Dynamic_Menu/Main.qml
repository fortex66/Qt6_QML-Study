...
Window {
    ...
    Rectangle {
        ...
        Rectangle{
            ...
            Text{
                anchors.centerIn: parent; text: "First Menu"; font.bold: true; font.pixelSize: 20; color: "white"
            }
            MouseArea {
                anchors.fill: parent
        ...
        Rectangle{
            ...
            color: "gray"; width: parent.width /2; height: 100
            Text{
                anchors.centerIn: parent; text: "Second Menu"; font.bold: true; font.pixelSize: 20; color: "white"
            }
            MouseArea{
                anchors.fill: parent
